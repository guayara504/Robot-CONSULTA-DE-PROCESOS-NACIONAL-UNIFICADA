...
class Consultor_1():
    ...
    def click_Proceso(driver,WaitForElement):
        ...
        WebDriverWait(driver,5).until(EC.presence_of_element_located((By.XPATH,'//*[@id="mainContent"]/div/div/div/div[2]/div/div/div[2]')))
